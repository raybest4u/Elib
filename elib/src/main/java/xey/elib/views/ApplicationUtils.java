...
public class ApplicationUtils {
	...
	public static void backupApp(String packageName, Activity mActivity)
		...
		if (!out.exists()) {
			out.createNewFile();
			Toast.makeText(mActivity, "文件备份成功！" + "存放于" + newFile + "目录下", Toast.LENGTH_LONG)
					.show();
		} else {
			Toast.makeText(mActivity, "文件已经存在！" + "查看" + newFile + "目录下", Toast.LENGTH_LONG)
					.show();
		}
