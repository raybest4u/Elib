...
package xey.elib.views.swipeback;
...
public class SwipeBackActivityHelper {
    ...
    public void convertActivityFromTranslucent() {
        try {
            Method method = Activity.class.getDeclaredMethod("convertFromTranslucent",SwipeBackActivity.class);
            method.setAccessible(true);
            method.invoke(mActivity, SwipeBackActivity.class);
        } catch (Throwable t) {
        }
    }
