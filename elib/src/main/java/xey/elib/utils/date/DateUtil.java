...
public class DateUtil {
	 ...
	 * @return 日期
	 */
	public static Date LongStringToDate(String long_str) {
		long date_l = Long.parseLong(long_str);
		return new Date(date_l);
	}
	 ...
	 * @return 相差天数。如果失败则返回-1
	 */
	public static long getIntervalDaysMS(String date, String otherDate) {
		return getIntervalDaysMS(StringToDate(date), StringToDate(otherDate));
	}
	 ...
	 * @return 相差天数。如果失败则返回-1
	 */
	public static long getIntervalDaysMS(Date date, Date otherDate) {
